...
import com.urja.carclinics.adapters.VehicleTypeAdapter;
...
import com.urja.carclinics.model.CarCareDetailing;
import com.urja.carclinics.model.Customer;
import com.urja.carclinics.model.Size;
import com.urja.carclinics.model.Vehicle;
...
public class WelcomeDashboardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnCardClickListner(new VehicleTypeAdapter.OnCardClickListner() {
            ...
            public void OnCardClicked(Vehicle vehicle, int position) {
                ...
                //Add the Car Type Name in the SharedPreference for Future use
    ...
    private void initializeDrawer(Bundle savedInstanceState) {
        ...
        if (!mName.isEmpty())
            textDrawable = TextDrawable.builder().buildRound(mName.substring(0, 1).toUpperCase(), ColorGenerator.MATERIAL.getRandomColor());
        mPersonImage.setBackground(textDrawable);
        mPersonImage.setImageDrawable(textDrawable);
