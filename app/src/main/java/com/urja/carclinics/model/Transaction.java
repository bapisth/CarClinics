package com.urja.carclinics.model;
...
public class Transaction implements Comparable<Transaction> {
    ...
    public Transaction(com.urja.carclinics.model.CarPickAddress carPickAddress, String requestStatus, String serviceRequestDate, List<ServiceRequest> serviceRequestList, String transactionId, String totalAmount) {
    ...
    public com.urja.carclinics.model.CarPickAddress getCarPickAddress() {
        return CarPickAddress;
    }

    public void setCarPickAddress(com.urja.carclinics.model.CarPickAddress carPickAddress) {
        CarPickAddress = carPickAddress;
    }
